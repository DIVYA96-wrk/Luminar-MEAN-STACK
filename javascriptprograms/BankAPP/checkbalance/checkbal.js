class Bank{
   ...
   static checkBalance(acno){
       let user=Bank.getAccountdetail();
       alert("YOUR AVAILABLE BALANCE IS :"+ user[acno]["balance"]);
       var balance=document.getElementById("balance");
       balance.textcontent="YOUR AVAILABLE BALANCE IS :"+ user[acno]["balance"];
   ...
   static login(){
       ...
       if (uss==1){
          //alert("login success");
          let user=Bank.checkBalance(accno)
